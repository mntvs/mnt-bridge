...
public interface RawLoopRepo {
    ...
    void rawLoop(Connection connection, MetaData metaData, BridgeProcessing beforeProcessing, BridgeProcessing afterProcessing, String schemaName, Long rawId, String groupId, Map<String, Object> param);
