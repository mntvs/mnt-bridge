create procedure prc_pre_process(IN a_raw_id bigint, IN a_raw_full_name TEXT, IN a_buf_full_name TEXT,
...
create procedure prc_post_process(IN a_raw_id bigint, IN a_raw_full_name text, IN a_processed_status integer,
...
begin
    ...
    for c_raw_rec in execute l_meta_data.raw_loop_query
        loop
            ...
            call prc_pre_process(c_raw_rec.id, l_meta_data.raw_full_name, l_meta_data.buf_full_name,
                                 l_meta_data.prc_exec_full_name, l_processed_status, l_error_message);
